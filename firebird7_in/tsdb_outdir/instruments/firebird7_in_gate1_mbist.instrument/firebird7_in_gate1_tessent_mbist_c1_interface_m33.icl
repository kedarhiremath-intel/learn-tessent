...
*/
 // ============================================================================
// == Description     : ICL description for firebird7_in_gate1_tessent_mbist_c1_interface_m33
...
Module firebird7_in_gate1_tessent_mbist_c1_interface_m33 {
    ...
    DataOutPort      ALL_SROW0_FUSE_ADD_REG[7:0] { Attribute connection_rule_option = "allowed_no_destination"; Source RA_INTERFACE_ALL_SPARE0_FUSE_ADD_REG[7:0]; }
    ...
    DataInPort       FROM_BISR_ALL_SROW0_FUSE_ADD_REG[7:0] { Attribute connection_rule_option = "allowed_tied_low"; }
    DataInPort       FROM_BISR_ALL_SROW0_ALLOC_REG { Attribute connection_rule_option = "allowed_tied_low"; }
    DataOutPort      ALL_SROW1_FUSE_ADD_REG[7:0] { Attribute connection_rule_option = "allowed_no_destination"; Source RA_INTERFACE_ALL_SPARE1_FUSE_ADD_REG[7:0]; }
    ...
    DataInPort       FROM_BISR_ALL_SROW1_FUSE_ADD_REG[7:0] { Attribute connection_rule_option = "allowed_tied_low"; }
    DataInPort       FROM_BISR_ALL_SROW1_ALLOC_REG { Attribute connection_rule_option = "allowed_tied_low"; }
    DataOutPort      All_SCOL0_FUSE_REG[6:0] { Attribute connection_rule_option = "allowed_no_destination"; Source RA_INTERFACE_All_SPARE0_FUSE_REG[6:0]; }
    DataInPort       FROM_BISR_All_SCOL0_FUSE_REG[6:0] { Attribute connection_rule_option = "allowed_tied_low"; }
