...
run_synthesis \
   ...
   -startup_file "./inputs/from_TEAMaker/tessent_synthesis_i0s_synopsys_dc.setup" \
...
system "./inputs/from_TEAMaker/split_tessent_synthesis_script.pl synthesis_outdir/${block}_${design_id}.synthesis_dc_shell/dc_shell.synthesis_tcl"

// Run the split synthesis scripts.  Wait for them all to finish.  Append synthesized components to DFT netlist
system "./inputs/from_TEAMaker/run_split_tessent_synthesis_jobs.pl synthesis_outdir/${block}_${design_id}.synthesis_dc_shell 500 | tee logfiles/run_split_tessent_synthesis_jobs_${design_id}.log"
