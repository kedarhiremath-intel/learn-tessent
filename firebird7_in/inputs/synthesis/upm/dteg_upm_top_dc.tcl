...
# Module name of the UPM partion that instantiates the SIP and the HIP
set partition_name dteg_upm_top

# Instance name of the instance of upm_fabric (i.e. the SIP) within the partition
set top_level upm1
...
if {$apm_en} {
   ...
   if {$decen} {
      create_generated_clock [get_ports dfx_upm_dcm_out[0]] \
        -name         ${partition_name}_dcm_out \
        -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/fin]] \
        -divide_by    1 \
        -master_clock ${partition_name}_hipclk_apm \
        -add
   }
   ...
   create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/u_upm_dftb_clk_divider_by_2/clkout] ] \
      -name         ${partition_name}_counter_div_2_clk_0 \
      -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/fin]] \
      -divide_by    2  \
      -master_clock ${partition_name}_hipclk_apm  \
      -add

   create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/u_upm_dftb_clk_divider_by_4/clkout] ] \
      -name         ${partition_name}_counter_div_4_clk_0 \
      -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/u_upm_dftb_clk_divider_by_2/clkout]] \
      -divide_by    2 \
      -master_clock ${partition_name}_counter_div_2_clk_0 \
      -add

   create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/u_upm_dftb_clk_divider_by_8/clkout] ] \
      -name         ${partition_name}_counter_div_8_clk_0 \
      -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/u_upm_dftb_clk_divider_by_4/clkout]] \
      -divide_by    2 \
      -master_clock ${partition_name}_counter_div_4_clk_0 \
      -add

   create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/u_upm_dftb_clk_divider_by_16/clkout]] \
      -name   ${partition_name}_counter_div_16_clk_0 \
      -source [get_object_name [get_pins $top_level/UPM_REGS.UPM_NON_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric/u_upm_dftb_clk_divider_by_8/clkout]] \
      -divide_by    2 \
      -master_clock ${partition_name}_counter_div_8_clk_0 \
      -add
}
...
if {$non_apm} {
   if {$thermal} {
      ...
      if {$decen} {
         create_generated_clock [get_ports dfx_upm_dcm_out[0]] \
            -name         ${partition_name}_dcm_out_0 \
            -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/fin]] \
            -divide_by    1 
            -master_clock ${partition_name}_fin_0 \
            -add

         create_generated_clock [get_ports dfx_upm_dcm_out[1]] \
            -name         ${partition_name}_dcm_out_1 \
            -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs_1/fin]] \
            -divide_by    1 \
            -master_clock ${partition_name}_fin_1 \
            -add
      }
      ...
      create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/u_upm_dftb_clk_divider_by_2/clkout] ] \
         -name         ${partition_name}_counter_div_2_clk_0 \
         -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/fin]] \
         -divide_by    2 \
         -master_clock ${partition_name}_fin_0 \
      ...
      create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/u_upm_dftb_clk_divider_by_4/clkout] ] \
         -name         ${partition_name}_counter_div_4_clk_0 \
         -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/u_upm_dftb_clk_divider_by_2/clkout]] \
         -divide_by    2 \
         -master_clock ${partition_name}_counter_div_2_clk_0 \
         -add

      create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/u_upm_dftb_clk_divider_by_8/clkout] ] \
         -name         ${partition_name}_counter_div_8_clk_0 \
         -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/u_upm_dftb_clk_divider_by_4/clkout]] \
         -divide_by    2 \
         -master_clock ${partition_name}_counter_div_4_clk_0 \
         -add

      create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/u_upm_dftb_clk_divider_by_16/clkout]] \
         -name         ${partition_name}_counter_div_16_clk_0 \
         -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs/u_upm_dftb_clk_divider_by_8/clkout]] \
         -divide_by    2 \
         -master_clock ${partition_name}_counter_div_8_clk_0 \
         -add

      create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs_1/u_upm_dftb_clk_divider_by_4/clkout] ] \
         -name         ${partition_name}_counter_div_4_clk_1 \
         -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs_1/u_upm_dftb_clk_divider_by_2/clkout]] \
         -divide_by    2 \
         -master_clock ${partition_name}_counter_div_2_clk_1 \
         -add

      create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs_1/u_upm_dftb_clk_divider_by_8/clkout] ] \
         -name         ${partition_name}_counter_div_8_clk_1 \
         -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs_1/u_upm_dftb_clk_divider_by_4/clkout]] \
         -divide_by    2 \
         -master_clock ${partition_name}_counter_div_4_clk_1 \
         -add

      create_generated_clock [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs_1/u_upm_dftb_clk_divider_by_16/clkout]] \
         -name         ${partition_name}_counter_div_16_clk_1 \
         -source       [get_object_name [get_pins $top_level/UPM_REGS.UPM_THERMAL.u_upm_reg/upm_clk_divider_upm_fabric_2_cntrs_1/u_upm_dftb_clk_divider_by_8/clkout]] \
         -divide_by    2 \
         -master_clock ${partition_name}_counter_div_8_clk_1 \
         -add
