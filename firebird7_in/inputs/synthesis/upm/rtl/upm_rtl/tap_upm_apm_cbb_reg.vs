...
///
///====================================================================================================================
`include "tap_upm_apm_cbb_reg.vh"
...
//======================================================================================================
//------------------------------------------------------------------------------------------------------
logic [TA_UPM_CBB_REG_COM_SHIFT_REG_SIZE - 1:0] ComShiftRegT731H;
//------------------------------------------------------------------------------------------------------
//______________________________________________________________________________________________________
//======================================================================================================
//
...
//======================================================================================================
//------------------------------------------------------------------------------------------------------
t_ta_ijtag_apm_cbb_reg  IJTAG_CBB_REG_RegTnnnH;      
t_ta_ijtag_apm_cbb_reg  IJTAG_CBB_REG_RegInTnnnH;    
...
always_comb begin : IJTAG_CBB_REG_UPDATEDR
       ...
       IJTAG_CBB_REG_RegInTnnnH    = (IJTAG_CBB_REG_UpdateDRT731H) ? t_ta_ijtag_apm_cbb_reg'(ComShiftRegT731H[TA_sib_reg__upm_cbb_reg_IJTAG_CBB_REG_SIZE - 1 : 0]) : IJTAG_CBB_REG_RegTnnnH;
end
//------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------
...
//======================================================================================================
//------------------------------------------------------------------------------------------------------
logic [TA_UPM_CBB_REG_COM_SHIFT_REG_SIZE - 1:0] ComShiftRegCaptureT731H;
logic [TA_UPM_CBB_REG_COM_SHIFT_REG_SIZE - 1:0] ComShiftRegTdiT731H;
logic [TA_UPM_CBB_REG_COM_SHIFT_REG_SIZE - 1:0] ComShiftRegInT731H;
//------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------
//Capture DR
always_comb begin : COMMON_SHIFT_TCLK_REG_CAPTURE
       ...
       unique casez(1'b1)
           selH    : ComShiftRegCaptureT731H[TA_sib_reg__upm_cbb_reg_IJTAG_CBB_REG_SIZE - 1:0] = IJTAG_CBB_REG_RegTnnnH; //IJTAG_CBB_REG 
           default : ComShiftRegCaptureT731H[TA_UPM_CBB_REG_COM_SHIFT_REG_SIZE          - 1:0] = '0;                     //CAPTURE DEFAULT VALUE 
       endcase
end
//------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------
...
always_comb begin : COMMON_SHIFT_TCK_REG_TDI
       ComShiftRegTdiT731H = {so_out, ComShiftRegT731H[TA_UPM_CBB_REG_COM_SHIFT_REG_SIZE - 1:1] };    /* lintra s-50519 */ //Shift right
       unique casez(1'b1)
           selH    : ComShiftRegTdiT731H[TA_sib_reg__upm_cbb_reg_IJTAG_CBB_REG_SIZE - 1] = so_out; /* lintra s-50519 */ //IJTAG_CBB_REG 
...
assign apm_en_cal     = IJTAG_CBB_REG_RegTnnnH.APM_EN_CAL;
assign apm_en_osc     = IJTAG_CBB_REG_RegTnnnH.APM_EN_OSC;
assign apm_en_step    = IJTAG_CBB_REG_RegTnnnH.APM_EN_STEP;
assign apm_osc_sel    = IJTAG_CBB_REG_RegTnnnH.APM_OSC_SEL;
assign apm_xtor_sel   = IJTAG_CBB_REG_RegTnnnH.APM_XTOR_SEL;
assign apm_mux_sel    = IJTAG_CBB_REG_RegTnnnH.APM_MUX_SEL;
assign apm_vdac_sel   = IJTAG_CBB_REG_RegTnnnH.APM_VDC_SEL;
//------------------------------------------------------------------------------------------------------
//______________________________________________________________________________________________________
//======================================================================================================
//
