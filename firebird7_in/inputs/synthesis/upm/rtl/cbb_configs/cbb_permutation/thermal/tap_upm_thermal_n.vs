...
u_upm_cbb_control_2_cntrs (
        ...
        .clk_out                 (clk_out_pre             ),  //upm_cbb_wrapper::UNIT interface::output 
...
//assign clk_out[1] = clk_out_pre[1] ^ debug_clk_gated;
// new clock scheme
`UPM_CLK_MUX_2TO1(clk_out[0], debug_clk_gated,clk_out_pre[0],    debug_clk_en)
`UPM_CLK_MUX_2TO1(clk_out[1], debug_clk_gated,clk_out_pre[1],    debug_clk_en)
//------------------------------------------------------------------------------------------------------
