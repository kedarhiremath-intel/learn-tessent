...
Module dteg_upm_top_apm_out {
   ...
   // -----------------------
   DataOutPort apm_en_sensor;
   DataOutPort apm_en_cal;
   DataOutPort apm_en_osc;
   DataOutPort apm_en_step;
   DataOutPort apm_osc_sel;
   DataOutPort apm_xtor_sel[1:0];
   DataOutPort apm_mux_sel[3:0];
   DataOutPort apm_vdac_sel[3:0];
   DataOutPort apm_debug_out;

   DataInPort apm_osc_out;
   DataInPort apm_debug_in;
...
Module ip_rtdr_ijtag_def_dteg_upm_top_upm_ijtag_chain_def {
   ...
   //TAP DR Sizes
   LocalParameter UPM_APM_CBB_reg_DR_SIZE = 15;
   ...
   //---------------------------
   Instance SIB_UPM_APM_CBB Of iclgen_intel_ijtag_sib {
      InputPort   si = si;
      InputPort   inst_so = UPM_APM_CBB_reg.so;
      InputPort   rstn = ijtag_reset_b;
   }
   //---------------------------
   Instance SIB_COUNTER_CTRL Of iclgen_intel_ijtag_sib {
      InputPort   si = SIB_UPM_APM_CBB.so;
   ...
   //---------------------------
   Instance UPM_APM_CBB_reg Of ip_rtdr_ijtag_def_dteg_upm_top_UPM_APM_CBB_reg_def {
      InputPort   si = SIB_UPM_APM_CBB.inst_si;
      InputPort   reset_b = rstn;
   }
   Alias UPM_APM_CBB_reg[$UPM_APM_CBB_reg_DR_SIZE-1:0] = UPM_APM_CBB_reg.DR;
   //---------------------------
...
//---------------------------
Module ip_rtdr_ijtag_def_dteg_upm_top_UPM_APM_CBB_reg_def {

   Attribute intel_desc = "UPM_APM_CBB_reg description";
   ...
   ScanRegister DR[14:0] {
      ScanInSource   si;
      ResetValue     15'b0;
      CaptureSource  DR[14:0];
      Attribute intel_TapRegSecurity = "SECURE_RED";
   }
   Alias POWER_ENABLE[0:0] = DR[0:0] {
      Attribute intel_desc = "Power enable";
      Attribute intel_AccessType = "RW";
   }
   Alias APM_VDC_SEL[3:0] = DR[4:1] {
      Attribute intel_desc = "apm_vdc_sel";
      Attribute intel_AccessType = "RW";
   }
   Alias APM_MUX_SEL[3:0] = DR[8:5] {
      Attribute intel_desc = "apm_mux_sel";
      Attribute intel_AccessType = "RW";
   }
   Alias APM_XTOR_SEL[1:0] = DR[10:9] {
      Attribute intel_desc = "apm_xtor_sel";
      Attribute intel_AccessType = "RW";
   }
   Alias APM_OSC_SEL[0:0] = DR[11:11] {
      Attribute intel_desc = "apm_osc_sel";
      Attribute intel_AccessType = "RW";
   }
   Alias APM_EN_STEP[0:0] = DR[12:12] {
      Attribute intel_desc = "apm_en_step";
      Attribute intel_AccessType = "RW";
   }
   Alias APM_EN_OSC[0:0] = DR[13:13] {
      Attribute intel_desc = "Enable oscillator";
      Attribute intel_AccessType = "RW";
   }
   Alias APM_EN_CAL[0:0] = DR[14:14] {
      Attribute intel_desc = "Eanble calibration";
      Attribute intel_AccessType = "RW";
   }
   Attribute tessent_use_in_dft_specification = "false";
} // end of ip_rtdr_ijtag_def_dteg_upm_top_UPM_APM_CBB_reg_def
