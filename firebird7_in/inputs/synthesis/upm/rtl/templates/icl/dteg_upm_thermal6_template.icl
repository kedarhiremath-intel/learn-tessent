...
Module ip_rtdr_ijtag_def_dteg_upm_top_upm_ijtag_chain_def {
   ...
   //TAP DR Sizes
   LocalParameter CBB_reg_DR_SIZE = 36;
   LocalParameter COUNTER_CTRL_reg_DR_SIZE = 26;
   LocalParameter COUNTER_RESULT_reg_DR_SIZE = 42;
   LocalParameter UPM_STATUS_reg_DR_SIZE = 26;
...
Module ip_rtdr_ijtag_def_dteg_upm_top_CBB_reg_def {
   ...
   ScanRegister DR[35:0] {
      ScanInSource   si;
      ResetValue     36'b0;
      CaptureSource  DR[35:0];
   ...
   Alias IJTAG_UPM1_CBB_CBB0_UPM_ADDR[4:0] = DR[5:1] {
      Attribute intel_desc = "cbb0_addr";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB1_POWER_ENABLE[0:0] = DR[6:6] {
      Attribute intel_desc = "cbb1_pwr_enable";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB1_UPM_ADDR[4:0] = DR[11:7] {
      Attribute intel_desc = "cbb1_addr";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB2_POWER_ENABLE[0:0] = DR[12:12] {
      Attribute intel_desc = "cbb2_pwr_enable";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB2_UPM_ADDR[4:0] = DR[17:13] {
      Attribute intel_desc = "cbb2_addr";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB3_POWER_ENABLE[0:0] = DR[18:18] {
      Attribute intel_desc = "cbb3_pwr_enable";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB3_UPM_ADDR[4:0] = DR[23:19] {
      Attribute intel_desc = "cbb3_addr";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB4_POWER_ENABLE[0:0] = DR[24:24] {
      Attribute intel_desc = "cbb4_pwr_enable";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB4_UPM_ADDR[4:0] = DR[29:25] {
      Attribute intel_desc = "cbb4_addr";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB5_POWER_ENABLE[0:0] = DR[30:30] {
      Attribute intel_desc = "cbb5_pwr_enable";
      Attribute intel_AccessType = "RW";
   }
   Alias IJTAG_UPM1_CBB_CBB5_UPM_ADDR[4:0] = DR[35:31] {
      Attribute intel_desc = "cbb5_addr";
      Attribute intel_AccessType = "RW";
   }
...
Module ip_rtdr_ijtag_def_dteg_upm_top_COUNTER_RESULT_reg_def {
   ...
   ScanRegister DR[41:0] {
      ScanInSource   si;
      ResetValue     42'b0;
      CaptureSource  42'bx;
      Attribute intel_TapRegSecurity = "SECURE_RED";
   }
   Alias IJTAG_COUNTER_RESULT_OVERFLOW0[0:0] = DR[0:0] {
      Attribute intel_desc = "counter_overflow0";
      Attribute intel_AccessType = "RO/V";
   }
   Alias IJTAG_COUNTER_RESULT_COUNTER_VALUE0[19:0] = DR[20:1] {
      Attribute intel_desc = "counter_current_value_result0";
      Attribute intel_AccessType = "RO/V";
   }
   Alias IJTAG_COUNTER_RESULT_OVERFLOW1[0:0] = DR[21:21] {
      Attribute intel_desc = "counter_overflow1";
      Attribute intel_AccessType = "RO/V";
   }
   Alias IJTAG_COUNTER_RESULT_COUNTER_VALUE1[19:0] = DR[41:22] {
      Attribute intel_desc = "counter_current_value_result1";
      Attribute intel_AccessType = "RO/V";
   }
   Attribute tessent_use_in_dft_specification = "false";
...
Module ip_rtdr_ijtag_def_dteg_upm_top_UPM_STATUS_reg_def {
   ...
   Alias IJTAG_UPM_STATUS_COUNTER_STATUS_0[0:0] = DR[24:24] {
      Attribute intel_desc = "counter status0";
      Attribute intel_AccessType = "RO/V";
   }
   Alias IJTAG_UPM_STATUS_COUNTER_STATUS_1[0:0] = DR[25:25] {
      Attribute intel_desc = "counter status1";
      Attribute intel_AccessType = "RO/V";
   }
   Attribute tessent_use_in_dft_specification = "false";
