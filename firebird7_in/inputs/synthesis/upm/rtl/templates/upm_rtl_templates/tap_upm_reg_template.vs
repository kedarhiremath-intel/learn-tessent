...
assign system_counter_value = {20'h00000,upm_counter_o_0};

assign system_counter_overflow = {1'b0,overflow_o_0};

assign system_counter_status = {1'b0,counter_status_0};
