...
//
//  Module tap_upm_reg_2_cntrs :  tdr logic 2 counters
//
//------------------------------------------------------------------------------


`include "tap_upm_reg_2_cntrs.vh"
...
logic upm_div_clk_1;                        
logic [UPM_NUMBER_OF_BITS_IN_COUNTER-1:0] upm_counter_o_1;
logic overflow_o_1;
...
//------------------------------------------------------------------------------------------------------
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] CNTR_CTRL_ComShiftRegT731H;
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] CNTR_RES_ComShiftRegT731H;
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] UPM_STATUS_ComShiftRegT731H;
//------------------------------------------------------------------------------------------------------
...
//======================================================================================================
//                                                                                                      
//                                  - upm_reg_2_cntrs IR select FF stage -                                        
//                                                                                                      
//______________________________________________________________________________________________________
//======================================================================================================
...
always_comb begin : IJTAG_COUNTER_RESULT_UPDATEDR
       ...
       IJTAG_COUNTER_RESULT_RegInTnnnH    = (IJTAG_COUNTER_RESULT_UpdateDRT731H) ? t_ta_ijtag_counter_result'(CNTR_RES_ComShiftRegT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_COUNTER_RESULT_SIZE - 1 : 0]) : IJTAG_COUNTER_RESULT_RegTnnnH;
end
//------------------------------------------------------------------------------------------------------
...
always_comb begin : IJTAG_COUNTER_RESULT_EXTERNAL_CAPTURE_DR
       ...
       captureIJTAG_COUNTER_RESULT_RegTnnnH.OVERFLOW1      = overflow_o_1;                  
       captureIJTAG_COUNTER_RESULT_RegTnnnH.COUNTER_VALUE1 = upm_counter_o_1;               
end
//------------------------------------------------------------------------------------------------------
...
always_comb begin : IJTAG_COUNTER_CTRL_UPDATEDR
       ...
       IJTAG_COUNTER_CTRL_RegInTnnnH    = (IJTAG_COUNTER_CTRL_UpdateDRT731H) ? t_ta_ijtag_counter_ctrl'(CNTR_CTRL_ComShiftRegT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_COUNTER_CTRL_SIZE - 1 : 0]) : IJTAG_COUNTER_CTRL_RegTnnnH;
end
//------------------------------------------------------------------------------------------------------
...
always_comb begin : IJTAG_UPM_STATUS_UPDATEDR
       ...
       IJTAG_UPM_STATUS_RegInTnnnH    = (IJTAG_UPM_STATUS_UpdateDRT731H) ? t_ta_ijtag_upm_status'(UPM_STATUS_ComShiftRegT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_UPM_STATUS_SIZE - 1 : 0]) : IJTAG_UPM_STATUS_RegTnnnH;
end
//------------------------------------------------------------------------------------------------------
...
always_comb begin : IJTAG_UPM_STATUS_EXTERNAL_CAPTURE_DR
       ...
       captureIJTAG_UPM_STATUS_RegTnnnH.CBB_CFG_ERROR         = cbb_power_en_error;        
		captureIJTAG_UPM_STATUS_RegTnnnH.COUNTER_STATUS_0	  = counter_status_0;
		captureIJTAG_UPM_STATUS_RegTnnnH.COUNTER_STATUS_1     = counter_status_1;
end
//------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] CNTR_RES_ComShiftRegCaptureT731H;
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] CNTR_RES_ComShiftRegTdiT731H;
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] CNTR_RES_ComShiftRegInT731H;
//------------------------------------------------------------------------------------------------------
...
always_comb begin : RES_COMMON_SHIFT_TCLK_REG_CAPTURE
       ...
       unique casez(1'b1)
           s3H     : CNTR_RES_ComShiftRegCaptureT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_COUNTER_RESULT_SIZE - 1:0] = captureIJTAG_COUNTER_RESULT_RegTnnnH; //IJTAG_COUNTER_RESULT 
           default : CNTR_RES_ComShiftRegCaptureT731H[TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE                 - 1:0] = '0;                                   //CAPTURE DEFAULT VALUE 
       endcase
end
//------------------------------------------------------------------------------------------------------
...
always_comb begin : RES_COMMON_SHIFT_TCK_REG_TDI
       ...
       CNTR_RES_ComShiftRegTdiT731H = {cntr_res_si, CNTR_RES_ComShiftRegT731H[TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:1] };    /* lintra s-50519 */ //Shift right

       unique casez(1'b1)
           s3H     : CNTR_RES_ComShiftRegTdiT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_COUNTER_RESULT_SIZE - 1] = cntr_res_si;   /* lintra s-50519 */ //IJTAG_COUNTER_RESULT 
...
//------------------------------------------------------------------------------------------------------
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] CNTR_CTRL_ComShiftRegCaptureT731H;
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] CNTR_CTRL_ComShiftRegTdiT731H;
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] CNTR_CTRL_ComShiftRegInT731H;
//------------------------------------------------------------------------------------------------------
...
always_comb begin : CTRL_COMMON_SHIFT_TCLK_REG_CAPTURE
       ...
       unique casez(1'b1)
           s2H     : CNTR_CTRL_ComShiftRegCaptureT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_COUNTER_CTRL_SIZE   - 1:0] = IJTAG_COUNTER_CTRL_RegTnnnH;          //IJTAG_COUNTER_CTRL 
           default : CNTR_CTRL_ComShiftRegCaptureT731H[TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE                 - 1:0] = '0;                                   //CAPTURE DEFAULT VALUE 
       endcase
end
//------------------------------------------------------------------------------------------------------
...
always_comb begin : CTRL_COMMON_SHIFT_TCK_REG_TDI
       ...
       CNTR_CTRL_ComShiftRegTdiT731H = {cntr_ctrl_si, CNTR_CTRL_ComShiftRegT731H[TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:1] };    /* lintra s-50519 */ //Shift right

       unique casez(1'b1)
           s2H     : CNTR_CTRL_ComShiftRegTdiT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_COUNTER_CTRL_SIZE   - 1] = cntr_ctrl_si;   /* lintra s-50519 */ //IJTAG_COUNTER_CTRL 
...
//------------------------------------------------------------------------------------------------------
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] UPM_STATUS_ComShiftRegCaptureT731H;
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] UPM_STATUS_ComShiftRegTdiT731H;
logic [TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:0] UPM_STATUS_ComShiftRegInT731H;
//------------------------------------------------------------------------------------------------------
...
always_comb begin : STATUS_COMMON_SHIFT_TCLK_REG_CAPTURE
       ...
       unique casez(1'b1)
           s4H     : UPM_STATUS_ComShiftRegCaptureT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_UPM_STATUS_SIZE     - 1:0] = captureIJTAG_UPM_STATUS_RegTnnnH;     //IJTAG_UPM_STATUS 
           default : UPM_STATUS_ComShiftRegCaptureT731H[TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE                 - 1:0] = '0;                                   //CAPTURE DEFAULT VALUE 
       endcase
end
//------------------------------------------------------------------------------------------------------
...
always_comb begin : STATUS_COMMON_SHIFT_TCK_REG_TDI
       ...
       UPM_STATUS_ComShiftRegTdiT731H = {upm_status_si, UPM_STATUS_ComShiftRegT731H[TA_UPM_REG_2_CNTRS_COM_SHIFT_REG_SIZE - 1:1] };    /* lintra s-50519 */ //Shift right

       unique casez(1'b1)
           s4H     : UPM_STATUS_ComShiftRegTdiT731H[TA_sib_reg__upm_reg_2_cntrs_IJTAG_UPM_STATUS_SIZE     - 1] = upm_status_si;   /* lintra s-50519 */ //IJTAG_UPM_STATUS 
...
`UPM_MUX_2TO1(counter_manual_i,  system_mode, system_window_mode, IJTAG_COUNTER_CTRL_RegTnnnH.WINDOW_MODE)

`UPM_MUX_2TO1(counter_start_i,  system_mode, system_counter_start, IJTAG_COUNTER_CTRL_RegTnnnH.START_MODE)

`UPM_MUX_2TO1(counter_stop_i,  system_mode, system_counter_stop, IJTAG_COUNTER_CTRL_RegTnnnH.STOP_MODE)

`UPM_MUX_2TO1(counter_init_i,  system_mode, system_window_counter_i, IJTAG_COUNTER_CTRL_RegTnnnH.UPM_WINDOW_SIZE)

`UPM_MUX_2TO1(fsm_start_i,  system_mode, upm_system_cfg_update, s2H & update)

`UPM_CLK_MUX_2TO1(mux_clk, dfx_upm_func_clk,tck , system_mode)

assign system_window_counter_o = fsm_counter_current_value_o;

assign system_fsm_state = fsm_state_o;

assign system_fsm_enable = fsm_enable_o;

assign system_fsm_active = fsm_counter_active_o;

assign system_counter_value = {upm_counter_o_1,upm_counter_o_0};

assign system_counter_overflow = {overflow_o_1,overflow_o_0};

assign system_counter_status = {counter_status_1,counter_status_0};

`UPM_MUX_2TO1(mux_rstn,  system_mode, dfx_upm_sys_rstn, trstb)
...
upm_controller_upm_fabric_2_cntrs (
...
assign counter_capture_i = s2H & capture & ~IJTAG_COUNTER_CTRL_RegTnnnH.WINDOW_MODE;

[% IF upm_variables.DFX_UPM_SYS_CTRL_EN == 1 %]

logic counter_capture_i_system;
assign counter_capture_i_system = upm_system_cfg_capture & (~system_window_mode);
// in system mode counter is reset if it was automode earlier and new load cfg occurs

`UPM_MUX_2TO1(capture_i,  system_mode, counter_capture_i_system, counter_capture_i)
...
upm_counter_upm_fabric_2_cntrs (
...
`UPM_MUX_2TO1(en_div_i,  system_mode, system_clock_divider, IJTAG_COUNTER_CTRL_RegTnnnH.CLOCK_DIVDER_SELECT)
...
//------------------------------------------------------------------------------------------------------
upm_clk_divider 
   upm_clk_divider_upm_fabric_2_cntrs (
...
//------------------------------------------------------------------------------------------------------
 ...
 upm_counter_upm_fabric_2_cntrs_1 (

         .tck_i             (mux_clk),   //input 
         .trstn_i           (mux_rstn & fdfx_powergood               ),   //input
         .clock_i           (upm_div_clk_1       ),   //input                                                        
         .cntr_start_i      (ctrl_cntr_start_o   ),   //input 
         .cntr_stop_i       (ctrl_cntr_stop_o    ),   //input 
         .capture_i         (capture_i   ),   			//input
         .upm_counter_o     (upm_counter_o_1     ),   //output
         .overflow_o        (overflow_o_1        ),    //output
		 .counter_status    (counter_status_1)
 );
...
//------------------------------------------------------------------------------------------------------
 upm_clk_divider 
    upm_clk_divider_upm_fabric_2_cntrs_1 (

         .fin       (cbb_clk_in[1]),                             //input
         .trstn_i   (mux_rstn & fdfx_powergood),                                     //input
         .en_div_i  (en_div_i),//input
         .fout      (upm_div_clk_1)                              //output
 );
...
`UPM_CLKBF(dfx_upm_dcm_out[1], upm_div_clk_1)
...
`UPM_MUX_2TO1(debug_clk_en,system_mode,system_debug_clk_en,IJTAG_COUNTER_CTRL_RegTnnnH.UPM_DEBUG_CLK_EN)
...
if( (CBB_HIP_TYPE == "UPM_THERMAL_1") || (CBB_HIP_TYPE == "UPM_THERMAL_2") || (CBB_HIP_TYPE == "UPM_THERMAL_3") || (CBB_HIP_TYPE == "UPM_THERMAL_4") || (CBB_HIP_TYPE == "UPM_THERMAL_5") || (CBB_HIP_TYPE == "UPM_THERMAL_6")) begin : UPM_THERMAL_CHECK
	...
	initial begin
	    $display("ERROR_VAL :- Found 2 counters in permutation   %s", CBB_HIP_TYPE);
		$finish;
	end
