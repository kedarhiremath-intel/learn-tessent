...
#
#
create_clock [get_ports apm_osc_out]  -name ${partition_name}_hipclk_apm  -period 400.0 -waveform {0  200}
#dont give sync on this hip clock since this is connected to fin
...
set_max_delay 1000.0 -to [get_ports apm_en_sensor]
set_max_delay 1000.0 -to [get_ports apm_en_cal]
set_max_delay 1000.0 -to [get_ports apm_en_osc]
set_max_delay 1000.0 -to [get_ports apm_en_step]
set_max_delay 1000.0 -to [get_ports apm_osc_sel]
set_max_delay 1000.0 -to [get_ports apm_xtor_sel]
set_max_delay 1000.0 -to [get_ports apm_mux_sel]
set_max_delay 1000.0 -to [get_ports apm_vdac_sel]
## these are not on any clock but for constarining using tck
set_max_delay 1000.0 -to [get_ports apm_debug_out]
set_max_delay 1000.0 -from [get_ports apm_debug_in]
