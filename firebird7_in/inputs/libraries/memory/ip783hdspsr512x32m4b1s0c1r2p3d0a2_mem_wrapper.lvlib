...
MemoryTemplate(ip783hdspsr512x32m4b1s0c1r2p3d0a2_mem_wrapper) {
  //ArrayRTLHier:  ip783hdspsr512x32m4b1s0c1r2p3d0a2.ip783hdspsr512x32m4b1s0c1r2p3d0a2_bmod.ip783hdspsr512x32m4b1s0c1r2p3d0a2_array.array[Address][din]
  MemoryType : SRAM;
  CellName : ip783hdspsr512x32m4b1s0c1r2p3d0a2_mem_wrapper;
  LogicalPorts : 1RW;
  ...
  MinHold : 0.00;
  MilliWattsPerMegaHertz : 0.00244;
  //       MilliWattsPerMegaHertz   <default>   : 0.13824;
  AddressCounter {
    Function(Address) {
      LogicalAddressMap {
        ColumnAddress[1:0] : Address[1:0];
        RowAddress[2:0] : Address[4:2];
        RowAddress[6:3] : Address[8:5];
      }
    }
    Function(RowAddress) {
      CountRange [0:127];
