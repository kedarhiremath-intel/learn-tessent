// Moving Inversion Partial Raster(MOVIPAR_Raster)
// The PMOVI_Raster algorithm is similar to PMOVI algorithm. Partial MOVI is an industry standard algorithm which is more complex than MarchC-. In the partial
...
Algorithm (IntelLVPMOVIRasterFastx){
