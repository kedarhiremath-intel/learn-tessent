...
Algorithm (IntelLVHammerFx){
 ...
 // ^(wD1)
  Instruction (WRITE_BACKGROUND_ROW) {
  ...
  Instruction (WRITE_BACKGROUND_COLUM) {
   OperationSelect : NoOperation;
   AddressSelectCmd : Select_B;
   ZAddressCmd : Increment;
   Y1AddressCmd : Increment;
   BranchToInstruction  : WRITE_BACKGROUND_ROW;
   NextConditions {
    Z_EndCount : On;
    Y1_EndCount : On;
   }
  ...
  // Instruction to ensure B is aligned with A
  ...
  Instruction (CLEAR_ARRAY_COLUM_BANK) {
   OperationSelect : NoOperation;
   AddressSelectCmd : Select_B;
   ZAddressCmd  : Increment;
   Y1AddressCmd : Increment;
   BranchToInstruction: CLEAR_ARRAY_ROW;
   NextConditions {
    Z_EndCount  : On;
    Y1_EndCount : On;
   }
