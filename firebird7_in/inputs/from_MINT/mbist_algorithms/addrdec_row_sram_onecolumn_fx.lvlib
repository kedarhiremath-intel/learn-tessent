...
// Address register A loops through all rows of one cloumn
// Address register B shifts through number of row address bits

Algorithm (IntelLVAddrDecodeRowOnlyFx) {
