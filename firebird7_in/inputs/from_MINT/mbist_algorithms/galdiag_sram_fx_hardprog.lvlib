// Galloping Diag (GALDiag)
// The galloping Diag algorithm behaves exactly as a full gallop except the target cell set is reduced
...
Algorithm (IntelLVGalDiagFx) {
 ...
 TestRegisterSetup {
  ...
  DataGenerator {
    LoadWriteData  : 16'b0000000000000000;
    LoadExpectData : 16'b0000000000000000;
  }
  // cmleon:  Set counter A to MaxRow
...
// ^(wI2, nbDiag(rTD3, rBI4), wD5)
  ...
  Instruction (READ_AWAY_ROW) {
   ...
   X1AddressCmd : Increment;
   Y1AddressCmd : Increment;
   // cmleon:  Added CounterA increment
