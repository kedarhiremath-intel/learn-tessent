...
// This algorithm is designed to exercise the logic of the address decoders.The MarchCRaster works the same way as MarchC -
// Short Notation: 
// ^(wD1) 
// ^(rD2, wI3) 
// ^(rI4, wD5)
...
Algorithm (IntelLVMarchCMinusRasterFastx){
